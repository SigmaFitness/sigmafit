...
export const TimeSpentChart = ({ height }: { height: number }) => {
    ...
    const { data: timeSpentData, isLoading } = useQuery<Insights_TimeSpent_Response, ErrorResponse>('getTimeSpentInsights', getTimeSpentInsights);
                                ...
                                tooltip: {
                                    callbacks: {
                                        title: function (this, tooltipItem) {
                                            return `Session Name: ${timeSpentData.dataPoints[tooltipItem[0].dataIndex].session_name}`
                                        },
                                        label(this, tooltipItem) {
                                            return `Session Length: ${timeSpentData.dataPoints[tooltipItem.dataIndex].duration} minutes`
                                        },
                                    }
                                },
                                legend: {
