...
import { ChevronLeftIcon, ChevronRightIcon, TicketIcon, XCircleIcon } from '@heroicons/react/solid'
    ...
    const handleAddOrModifyBlockSubmit = async (values: { sets_data: SessionInstanceState_SetData[] }) => {
        try {
            ...
            if (workoutIndex + 1 !== workouts.length) setWorkoutIndex((val) => val + 1)
                ...
                if (confirm('Yay! 🥳 That was the last workout. Do you want to end this session?')) {
                                ...
                                workouts.length ?
                                    ...
                                    <>
                                        ...
                                        <div className='ml-4 mt-2 mb-4'>
                                            <Menu.Button className="btn btn-sm text-secondary-content">Workout List</Menu.Button>
                                            <Transition
                                                show={open}
                                                as={Fragment}
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <Menu.Button className="absolute top-1 right-1 btn btn-ghost btn-square"><XCircleIcon className='w-10' /></Menu.Button>
                                                    <div className='font-black text-xl px-10'>Workout List</div>
                                                    {/* bg-base-100  */}
                                                    {/* <ul className=> */}
                                                    <div className='font-bold px-4 pb-4 text-primary text-lg'>

                                                    </div>
                                                    {workouts && workouts.map((workout, index: number) => {
                                                        return (
                                                            <Menu.Item as='li'
                                                                className={'relative cursor-default select-none py-2 pl-10 pr-4 text-gray-900 hover:bg-amber-200 ' + (index === workoutIndex ? 'font-medium' : '')}
                                                                key={index}
                                                                onClick={() => {
                                                ...
                                                <div>
                                                    ...
                                                    <div className='col-span-6 flex justify-between mt-8 gap-3'>
                                                        ...
                                                        <button
                                                            ...
                                                            className='btn flex-grow space-x-1' type='submit'>
                                                                Next Workout
