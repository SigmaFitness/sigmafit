...
import { addNewSessionSchema, ErrorResponse, getSessionSchemaDetails } from "../../../api"
import { MetaHead } from "../../../components/Head"
import { Navbar } from "../../../components/Navbar"
import SessionSchemaForm, { SessionSchemaFormValueType } from "../../../components/Forms/SessionSchemaForm"
import { SessionSchemaCreateRequest, SessionSchemaCreateResponse, SessionSchemaDetailsResponse } from "@sigmafit/commons"
...
const SessionSchemaClone = () => {
    ...
    const { mutate } = useMutation<SessionSchemaCreateResponse, ErrorResponse, SessionSchemaCreateRequest>('addNewSessionSchema', addNewSessionSchema, {
        onSettled(data, error) {
            if (error) {
