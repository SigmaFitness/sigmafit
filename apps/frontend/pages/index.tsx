          ...
          <div className="mockup-phone scale-75 sm:scale-90 border-blue-600 mx-0">
            ...
            <div className="display">
              <div className="artboard artboard-demo phone-4 max-w-full">
                <img src="/mocks/9.png" className="rounded-lg w-[100%] mt-2" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-none mx-auto px-4 flex flex-col prose break-words">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 items-center w-full border-b-2 py-5 my-3">
            <div>
              ...
              <div className="text-xl">
                Log all your workouts on SigmaFit. It's simpler and more rugged
                than any notebook out there. It will help you with the planning,
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 items-center w-full border-b-2 py-5 my-3">
            ...
            <div className="">
              ...
              <div className="text-xl">
                SigmaFit lets you log the thing you want to track. You can track
                distance, duration, weight, reps, and anything based on your
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 items-center w-full border-b-2 py-5 my-3">
            <div>
              ...
              <div className="text-xl">
                In SigmaFit, it's super easy to get started with community
                Training Routines. If you have a custom workout plan, you can
                create that too. SigmaFit is super customizable, and creating a
                training routine is a cakewalk.
              </div>
            </div>
            <div className="flex justify-end">
              <PhoneMock
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 items-center w-full border-b-2 py-5 my-3">
            ...
            <div>
              ...
              <div className="text-xl">
                Personal Records are not just any numbers. They're very special
                for every athlete out there. SigmaFit keeps track of it and
                provides extra motivation to make it even bigger!
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 items-center w-full border-b-2 py-5 my-3">
            <div>
              ...
              <div className="text-xl">
                If you've created a training routine you're particularly proud
                of, you can share it with the community and friends.
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 items-center w-full border-b-2 py-5 my-3">
            ...
            <div>
              ...
              <div className="text-xl">
                SigmaFit is a progressive web app. You can run it on any browser
                environment. It takes lesser resources and blazingly fast.
              </div>
            </div>
          </div>
        </div>
