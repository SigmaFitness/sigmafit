...
import { SessionSchemaAllResponse, SessionSchemaCreateRequest, SessionSchemaCreateResponse, SessionSchemaDetailsResponse } from '@sigmafit/commons';
...
router.get('/details/:id', isAuthenticated, async (req, res) => {
    try {
        ...
        const resp:SessionSchemaDetailsResponse = {
            schema_blocks: [...data.workout_schema, ...data.superset_schema],
...
router.post('/create/', isAuthenticated, async (req, res) => {
    try {
        ...
        const validatedData: SessionSchemaCreateRequest = await addSessionSchemaPayloadValidator.validate(data)
