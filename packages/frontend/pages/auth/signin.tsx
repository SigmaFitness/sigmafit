...
import { ErrorResponse, signInUserMutation } from "../../api"
...
const SignIn = () => {
    const { isLoading: waitingForServerResponse, mutate, error, data } = useMutation<any,ErrorResponse, any>(signInUserMutation)
