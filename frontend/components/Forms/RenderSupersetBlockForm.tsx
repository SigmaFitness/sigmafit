...
import { superset_schema_block, workout_category, workout_option } from "./SessionSchemaForm";
import { RenderWorkoutForm } from "./RenderWorkoutForm";



export const RenderSupersetBlockForm = ({ fieldPrefix, superset_schema_instance, workoutOptions, workoutIdToDataMap, removeInstance,setIsCreateNewWorkoutModalOpen }: {
    fieldPrefix: string,
